package cool.zack1stplayer.RandomStuffs;
...
@Mod(RandomStuffsMain.MODID)
public class RandomStuffsMain {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "randomstuffs";
...
//    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("random_stuffs", () -> CreativeModeTab.builder()
    ...
    public RandomStuffsMain(FMLJavaModLoadingContext context) {
